...
export function memberPrompt({ today, fullName, teamId, isSale }: MemberPromptVars): string {
  ...
  return [
    ...
    'việc đó. Hãy nói thật, và CHỈ đưa ví dụ cụ thể — KHÔNG viết mẫu dạng ngoặc nhọn:',
    '"Mình chưa mở được việc này. Bạn nhắn lại gọn kiểu \'thiết kế post 1 ảnh Maple\'',
    '(tên loại việc rồi tới tên khách), hoặc chọn thẳng ở mục Cần làm nhé."',
    '',
